...
Community stormwater plan and live engagement platform for South Walton's 30A
corridor. The 30A corridor's buildout is outpacing its drainage infrastructure,
and the region's rare coastal dune lakes are bearing the cost. The site lays out
the problem, the plan, how residents can make their voices heard, durable media
homes for each Protect30A district, and the new resident live-room experience.
...
- `/districts/rosemary-beach/`
- `/districts/alys-beach/`
- `/districts/watersound-seacrest-prominence-origins/`
- `/districts/seagrove-seaside-watercolor/`
- `/districts/grayton-blue-mountain/`
- `/districts/santa-rosa-beach-gulf-place-dune-allen/`
- `/districts/sandestin-miramar-beach-seascape/`
- `/districts/30a-stormwater/`
